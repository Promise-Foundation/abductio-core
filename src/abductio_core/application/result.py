...
class StopReason(str, Enum):
    ...
    CLOSURE_GATES_UNMET = "CLOSURE_GATES_UNMET"
    EPISTEMICALLY_EXHAUSTED = "EPISTEMICALLY_EXHAUSTED"
    POLICY_CONFIG_INCOMPATIBLE = "POLICY_CONFIG_INCOMPATIBLE"
    NO_HYPOTHESES = "NO_HYPOTHESES"
    NO_LEGAL_OP = "NO_LEGAL_OP"
    OP_LIMIT_REACHED = "OP_LIMIT_REACHED"
    MECE_CERTIFICATE_FAILED = "MECE_CERTIFICATE_FAILED"
